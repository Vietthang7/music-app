...
router.post("/create", upload.single('avatar'), uploadCloud.uploadSingle, user_validate_1.Register, controller.createPost);
router.get("/edit/:id", controller.edit);
router.patch("/edit/:id", upload.single('avatar'), uploadCloud.uploadSingle, user_validate_2.editPatch, controller.editPatch);
